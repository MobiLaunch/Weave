...
| **Mixed feelings** | Feelings are often mixed, so mood sensing picks up the two strongest from a much larger vocabulary, including intensifiers ("so", "really"), negation ("not happy") and emoji. The world blends to match: happy + sad is *Bittersweet*, a sunny meadow under passing storms; angry + inspired is *Driven*, a crystal world with smouldering volcanoes. Every pairing has its own name. You can also pick two moods yourself. |
